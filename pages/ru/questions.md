...
В зональном клик-тесте тестируемое изображение заранее разделяется на отдельные области (зоны) и любой клик респондента фиксируется как выбор одной из них. Анализировать результаты зонального клик-теста можно также как и результаты обычного вопроса с множественным выбором. 
